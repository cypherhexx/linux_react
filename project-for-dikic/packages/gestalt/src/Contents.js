...
const MARGIN = 23;
export const CARET_HEIGHT = 23;
const CARET_OFFSET_FROM_SIDE = 23;
...
export default class Contents extends React.Component<Props, State> {
  static propTypes = {
    shadowSize: PropTypes.oneOf(['sm', 'md', 'lg', 'xl', 'xxl']),
  ...
  render() {
    const { bgColor, caret, children, width, shadowSize } = this.props;
